...
async function run() {
  console.log('=== Faza 23 SLO Mes Vault FINAL (W122) ===\n');
  const paths = [
    '/api/analytics/platform/slo-alerting/readiness',
    '/api/analytics/platform/playwright-mes-eam-crm/readiness',
    '/api/analytics/platform/vault-kms-unseal/readiness',
