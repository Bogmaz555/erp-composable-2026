...
if command -v npx >/dev/null 2>&1; then
  npx --yes jest test/eto-spine-chain.contract.spec.ts test/eto-operational-payload.contract.spec.ts test/double-bom.contract.spec.ts test/genealogy-chain.contract.spec.ts test/faza3-proc-chain.contract.spec.ts test/faza4-ncr.contract.spec.ts test/faza4-eam.contract.spec.ts test/faza4-capa.contract.spec.ts test/ci-auth-readiness.contract.spec.ts test/ci-auth-workflow.contract.spec.ts test/ci-auth-enforce.contract.spec.ts test/ci-auth-live.contract.spec.ts test/ci-auth-regression.contract.spec.ts test/frontend-bi-readiness.contract.spec.ts test/bi-projection.contract.spec.ts test/bi-scheduler.contract.spec.ts test/bi-retention.contract.spec.ts test/bi-metrics.contract.spec.ts test/pm-e2e.contract.spec.ts test/faza11-frontend-bi-final.contract.spec.ts test/faza12-scheduler-ci-final.contract.spec.ts test/faza13-retention-ci-live-final.contract.spec.ts test/faza14-metrics-ci-regression-final.contract.spec.ts test/grafana-bi.contract.spec.ts test/ci-auth-keycloak.contract.spec.ts test/faza15-grafana-ci-hardening-final.contract.spec.ts test/grafana-provision.contract.spec.ts test/ci-auth-enforce-prod.contract.spec.ts test/faza16-observability-ci-prod-final.contract.spec.ts test/bi-alerts.contract.spec.ts test/vault-tls-prod.contract.spec.ts test/faza17-alerts-matrix-vault-final.contract.spec.ts test/alert-notify.contract.spec.ts test/mtls-gateway.contract.spec.ts test/faza18-notify-matrix-mtls-final.contract.spec.ts test/alert-escalation.contract.spec.ts test/mtls-proxy.contract.spec.ts test/faza19-escalation-matrix-mtls-proxy-final.contract.spec.ts test/alert-oncall.contract.spec.ts test/mtls-client-verify.contract.spec.ts test/faza20-oncall-matrix-clientverify-final.contract.spec.ts test/slo-burn-rate.contract.spec.ts test/tls-rotation.contract.spec.ts test/faza21-slo-chain-tls-final.contract.spec.ts test/grafana-slo-dashboard.contract.spec.ts test/vault-secrets-rotation.contract.spec.ts test/faza22-slo-proc-vault-final.contract.spec.ts test/slo-alerting.contract.spec.ts test/vault-kms-unseal.contract.spec.ts test/faza23-slo-mes-vault-final.contract.spec.ts test/slo-routing.contract.spec.ts test/vault-audit.contract.spec.ts test/faza24-routing-hr-vault-final.contract.spec.ts test/prod-observability.contract.spec.ts test/vault-ha.contract.spec.ts test/faza25-prod-matrix-vaultha-final.contract.spec.ts test/k8s-deploy.contract.spec.ts test/vault-raft.contract.spec.ts test/faza26-k8s-visual-raft-final.contract.spec.ts test/helm-deploy.contract.spec.ts test/quality-eam-prod.contract.spec.ts test/faza27-helm-visualdiff-qualityeam-final.contract.spec.ts test/k8s-extended.contract.spec.ts test/tenant-hardening.contract.spec.ts test/ksef-prod.contract.spec.ts test/faza28-k8s-tenant-ksef-final.contract.spec.ts --passWithNoTests 2>/dev/null \
