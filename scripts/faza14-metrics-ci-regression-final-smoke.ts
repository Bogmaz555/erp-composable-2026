...
async function run() {
  console.log('=== Faza 14 Metrics & CI Regression FINAL (W86) ===\n');
  const paths = [
    '/api/analytics/platform/bi-metrics/readiness',
    '/api/analytics/platform/playwright-stack/readiness',
    '/api/analytics/platform/ci-auth-regression/readiness',
